...
import me.choketa.food.PrimalFoods;
...
public class PrimalItems {
    ...
    public static final Item VEGETABLE_JUICE = registerItem(
            "vegetable_juice",
            properties -> new Item(properties.
                    food(PrimalFoods.VEGETABLE_JUICE, PrimalFoods.VEGETABLE_JUICE_CONSUMABLE)
